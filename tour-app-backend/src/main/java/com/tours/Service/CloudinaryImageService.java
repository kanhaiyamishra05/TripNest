...
public class CloudinaryImageService {
    ...
    public CloudinaryImageService(
        ...
        if (cloudName == null || cloudName.trim().isEmpty() || cloudName.contains("your-cloudinary") || cloudName.startsWith("<")) {
            this.isDummyMode = true;
            this.cloudinary = null;
            logger.warning("Cloudinary credentials are placeholders. Activating dummy/fallback mode for image uploads.");
        } else {
    ...
    public String uploadImage(MultipartFile file) {
        ...
        if (isDummyMode) {
            logger.info("Dummy mode active. Bypassing Cloudinary and returning a sample travel image URL.");
            double rand = Math.random();
            if (rand < 0.33) {
                return "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=1000"; // Road trip
            } else if (rand < 0.66) {
                return "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1000"; // Beach
            } else {
                return "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=1000"; // Lake & boat
            }
        }
        try {
            if (file.isEmpty()) {
    ...
    public void deleteImage(String imageUrl) {
        ...
        if (isDummyMode) {
            logger.info("Dummy mode active. Skipping image deletion.");
            return;
        }
