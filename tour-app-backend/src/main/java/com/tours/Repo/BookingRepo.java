...
public interface BookingRepo extends JpaRepository<Booking, Long> {
    ...
    // Fetch bookings for a specific customer and payment status
    List<Booking> findByCustomerAndPaymentStatus(Users customer, Booking.PaymentStatus paymentStatus);

    // Check if customer already has a booking with a specific payment status for a tour
    boolean existsByCustomerAndTourIdAndPaymentStatus(Users customer, Long tourId, Booking.PaymentStatus paymentStatus);
